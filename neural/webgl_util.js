export class webgl_util {
    ...
    static createProgram(ctx, vsSource, fsSource) {
        ...
        const vertexShader = webgl_util.createShader(ctx, ctx.VERTEX_SHADER, vsSource);
        ctx.attachShader(shaderProgram, vertexShader);
        const fragmentShader = webgl_util.createShader(ctx, ctx.FRAGMENT_SHADER, fsSource);
